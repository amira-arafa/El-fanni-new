      ...
      <div className="profile-page-wrapper">
        ...
        <div className="d-flex justify-content-end sort-icon-wrapper align-items-baseline">
          <div className="col-sm-6">
            <p className="glory-semi-bold heading-4 btnColor mb-0">
              {single_collection?.name}
            </p>
          </div>
              ...
              modalBody={
                <div className="row align-items-center">
                  ...
                  <div className="d-flex justify-content-end">
                    ...
                    <div onClick={() => handleDeleteCollection()}>
                      {" "}
                      <Button
                        className="yes-remove-btn-collection"
        ...
        {single_collection?.courses?.length > 0 ? (
          <>
            {single_collection &&
              single_collection.courses?.map((course, i) => (
                <div className="row course-results-wrapper mb-3 mx-0" key={i}>
