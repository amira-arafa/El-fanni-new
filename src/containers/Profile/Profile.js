  ...
  return (
    ...
    <div className="profile-page-wrapper">
      <div className="profile-tabs-wrapper">
        ...
        <div className="d-flex justify-content-end sort-icon-wrapper align-items-center">
          ...
          <div>
            <div className="sort-arrows mx-3">
              <img src={sortUp} alt="sort-up" width="24px" height="24px"
        ...
        {activeTab === 1 && (
          <div>
            {favourites_list.length>0 ? <div>{favourites_list?.map((course) => (
              <div className="row course-results-wrapper mb-3 mx-0">
                <div className="col-sm-4">
                  <img src={course.cover} alt="course-img" width="100%"></img>
                </div>
                <div className="col-sm-6">
                  <p className="inter-semi-bold heading-3 course-title-mobile">{course.title}</p>
                ...
                <div className="col-sm-2 text-end cart-desktop-more">
                  <div className="dropdown ddp-btn ">
                    ...
                    >
                      <li
                        onClick={() => handleRemoveFromFavourites(course._id)}
                        className="cursor-pointer"
                      >
                        <a className="dropdown-item">
            ...
            ))}</div> : <div><EmptyState className="mb-5" text={<FormattedMessage id="noFav"/>}/></div>}
          </div>
        )}
          ...
          {collections_list.length>0 ? <div>
            {collections_list?.map((collection) => (
              ...
              >
                ...
                <div className="col-sm-9">
                  <p className="inter-semi-bold heading-3">{collection.name}</p>
                </div>
              </div>
            ))}
          </div>: <EmptyState className="mb-5" text={<FormattedMessage id="noCollection"/>} subText={<FormattedMessage id="emptyCollectionMsg"/>} btnIcon={addIcon}/>}
